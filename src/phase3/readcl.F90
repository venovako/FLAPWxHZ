SUBROUTINE READCL(FN, M, N, TPC, JSTRAT, NSWP, INFO)
  IMPLICIT NONE
  CHARACTER(LEN=*,KIND=c_char), INTENT(OUT) :: FN
  INTEGER, INTENT(OUT) :: M, N, TPC, JSTRAT(2), NSWP(2), INFO

  CHARACTER(LEN=FNL) :: ARG
  INTEGER :: TMP

  INFO = 0
  IF (COMMAND_ARGUMENT_COUNT() .NE. 8) STOP 'phase3.exe FN M N TPC JSTRAT1 NSWP1 JSTRAT2 NSWP2'
