SUBROUTINE ZHZL1_PSTEP(M,N, H,LDH, S,LDS, Z,LDZ, JVEC, DTOL, NPAIRS,JS,JSPAIR, STEP,PPV,VPS,VEC, SNROT)
  IMPLICIT NONE

  INTEGER, INTENT(IN) :: M,N, LDH,LDS,LDZ, JVEC(M), NPAIRS,JS(JSMLEX),JSPAIR(2,JS(JSMLEX),JS(JSMLEX-1)), STEP,PPV,VPS,VEC
...
SUBROUTINE ZHZL1P(M,N, H,LDH, JVEC, S,LDS, Z,LDZ, JS,JSPAIR, NSWP,TPC,&
  ...
  DO SWEEP = 1, NSWP
     ...
     DO STEP = 1, NSTEPS
        ...
        DO VEC = 1, VPS
           CALL ZHZL1_PSTEP(M,N, H,LDH, S,LDS, Z,LDZ, JVEC, DTOL, NPAIRS,JS,JSPAIR, STEP,PPV,VPS,VEC, SNROT)
        END DO
        !$OMP END PARALLEL DO
     END DO
