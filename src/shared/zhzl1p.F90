...
SUBROUTINE ZHZL1P(M,N, H,LDH, JVEC, S,LDS, Z,LDZ, JS,JSPAIR, NSWP,TPC,&
  ...
  INTEGER, INTENT(IN) :: M,N, LDH,LDS,LDZ, JVEC(M), JS(JSMLEX),JSPAIR(2,JS(JSMLEX),JS(JSMLEX-1)), NSWP,TPC
  ...
  IF (NROT(1) .GT. 0) THEN
     ...
     !$OMP& SHARED(M,N,H,S,Z,JVEC,TPC) PRIVATE(I,J,L,P,Q,DTOL,EE,EY,EW,SY,SW,SS,DTMP1,DTMP2,ZTMP1,ZTMP2)
