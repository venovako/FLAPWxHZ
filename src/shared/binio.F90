...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  SUBROUTINE BREAD_X(FD, X, L, G, ATOM, INFO)
    ...
    INFO = INT(VN_BREAD(INT(FD,c_int), C_LOC(X), C_SIZEOF(X), ATOM * C_SIZEOF(X)))
  ...
  SUBROUTINE BREAD_T(FD, T, L, ATOM, INFO)
    ...
    INFO = INT(VN_BREAD(INT(FD,c_int), C_LOC(T), C_SIZEOF(T), ATOM * C_SIZEOF(T)))
  ...
  SUBROUTINE BREAD_U(FD, U, L, ATOM, INFO)
    ...
    INFO = INT(VN_BREAD(INT(FD,c_int), C_LOC(U), C_SIZEOF(U), ATOM * C_SIZEOF(U)))
  ...
  SUBROUTINE BREAD_Y(FD, Y, L, a, IFCOL, NCOLS, INFO)
    ...
    INFO = INT(VN_BREAD(INT(FD,c_int), C_LOC(Y), C_SIZEOF(Y), (IFCOL-1) * (2*L*a) * C_SIZEOF(Z_ZERO)))
  ...
  SUBROUTINE BREAD_W(FD, W, L, a, IFCOL, NCOLS, INFO)
    ...
    INFO = INT(VN_BREAD(INT(FD,c_int), C_LOC(W), C_SIZEOF(W), (IFCOL-1) * (2*L*a) * C_SIZEOF(Z_ZERO)))
  ...
  SUBROUTINE BREAD_J(FD, J, L, a, SZ, INFO)
    ...
    SZ = INT(VN_BREAD(INT(FD,c_int), C_LOC(J), C_SIZEOF(J), 0))
  ...
  SUBROUTINE BREAD_Z(FD, Z, G, SZ, INFO)
    ...
    SZ = INT(VN_BREAD(INT(FD,c_int), C_LOC(Z), C_SIZEOF(Z), 0))
  ...
  SUBROUTINE BREAD_YU(FD, YU, L, a, G, SZ, INFO)
    ...
    SZ = INT(VN_BREAD(INT(FD,c_int), C_LOC(YU), C_SIZEOF(YU), 0))
  ...
  SUBROUTINE BREAD_SY(FD, SY, G, SZ, INFO)
    ...
    SZ = INT(VN_BREAD(INT(FD,c_int), C_LOC(SY), C_SIZEOF(SY), 0))
  ...
  SUBROUTINE BREAD_WV(FD, WV, L, a, G, SZ, INFO)
    ...
    SZ = INT(VN_BREAD(INT(FD,c_int), C_LOC(WV), C_SIZEOF(WV), 0))
  ...
  SUBROUTINE BREAD_SW(FD, SW, G, SZ, INFO)
    ...
    SZ = INT(VN_BREAD(INT(FD,c_int), C_LOC(SW), C_SIZEOF(SW), 0))
  ...
  SUBROUTINE BREAD_ZZ(FD, ZZ, G, SZ, INFO)
    ...
    SZ = INT(VN_BREAD(INT(FD,c_int), C_LOC(ZZ), C_SIZEOF(ZZ), 0))
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  SUBROUTINE BWRITE_Y(FD, Y, L, G, ATOM, INFO)
    ...
    INFO = INT(VN_BWRITE(INT(FD,c_int), C_LOC(Y), C_SIZEOF(Y), ATOM * C_SIZEOF(Y)))
  ...
  SUBROUTINE BWRITE_W(FD, W, L, G, ATOM, INFO)
    ...
    INFO = INT(VN_BWRITE(INT(FD,c_int), C_LOC(W), C_SIZEOF(W), ATOM * C_SIZEOF(W)))
  ...
  SUBROUTINE BWRITE_J(FD, J, L, ATOM, INFO)
    ...
    INFO = INT(VN_BWRITE(INT(FD,c_int), C_LOC(J), C_SIZEOF(J), ATOM * C_SIZEOF(J)))
  ...
  SUBROUTINE BWRITE_YU(FD, YU, L, a, IFCOL, NCOLS, INFO)
    ...
    INFO = INT(VN_BWRITE(INT(FD,c_int), C_LOC(YU), C_SIZEOF(YU), (IFCOL-1) * (2*L*a) * C_SIZEOF(Z_ZERO)))
  ...
  SUBROUTINE BWRITE_WV(FD, WV, L, a, IFCOL, NCOLS, INFO)
    ...
    INFO = INT(VN_BWRITE(INT(FD,c_int), C_LOC(WV), C_SIZEOF(WV), (IFCOL-1) * (2*L*a) * C_SIZEOF(Z_ZERO)))
  ...
  SUBROUTINE BWRITE_Z(FD, Z, G, IFCOL, NCOLS, INFO)
    ...
    INFO = INT(VN_BWRITE(INT(FD,c_int), C_LOC(Z), C_SIZEOF(Z), (IFCOL-1) * G * C_SIZEOF(Z_ZERO)))
  ...
  SUBROUTINE BWRITE_E(FD, E, IFCOL, NCOLS, INFO)
    ...
    INFO = INT(VN_BWRITE(INT(FD,c_int), C_LOC(E), C_SIZEOF(E), (IFCOL-1) * C_SIZEOF(D_ZERO)))
  ...
  SUBROUTINE BWRITE_SS(FD, SS, IFCOL, NCOLS, INFO)
    ...
    INFO = INT(VN_BWRITE(INT(FD,c_int), C_LOC(SS), C_SIZEOF(SS), (IFCOL-1) * C_SIZEOF(D_ZERO)))
  ...
  SUBROUTINE BWRITE_EY(FD, EY, IFCOL, NCOLS, INFO)
    ...
    INFO = INT(VN_BWRITE(INT(FD,c_int), C_LOC(EY), C_SIZEOF(EY), (IFCOL-1) * C_SIZEOF(D_ZERO)))
  ...
  SUBROUTINE BWRITE_SY(FD, SY, IFCOL, NCOLS, INFO)
    ...
    INFO = INT(VN_BWRITE(INT(FD,c_int), C_LOC(SY), C_SIZEOF(SY), (IFCOL-1) * C_SIZEOF(D_ZERO)))
  ...
  SUBROUTINE BWRITE_EW(FD, EW, IFCOL, NCOLS, INFO)
    ...
    INFO = INT(VN_BWRITE(INT(FD,c_int), C_LOC(EW), C_SIZEOF(EW), (IFCOL-1) * C_SIZEOF(D_ZERO)))
  ...
  SUBROUTINE BWRITE_SW(FD, SW, IFCOL, NCOLS, INFO)
    ...
    INFO = INT(VN_BWRITE(INT(FD,c_int), C_LOC(SW), C_SIZEOF(SW), (IFCOL-1) * C_SIZEOF(D_ZERO)))
  ...
  SUBROUTINE BWRITE_ZZ(FD, ZZ, G, IFCOL, NCOLS, INFO)
    ...
    INFO = INT(VN_BWRITE(INT(FD,c_int), C_LOC(ZZ), C_SIZEOF(ZZ), (IFCOL-1) * G * C_SIZEOF(Z_ZERO)))
